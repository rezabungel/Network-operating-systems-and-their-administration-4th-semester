...
Task 2 - implement of client/server chat using sockets. Go to [Task 2](./Practice/Task%202/).  
Task 3 - implement of a client-server application (based on sockets) in which the client sends bash commands to the server, and the server executes them and returns the result to the client. Go to [Task 3](./Practice/Task%203/).  
